...
const options = ['Shorten', 'Exemplify', 'Expand', 'Simplify']
const options1 = ['Conversational', 'Enthusiastic', 'Funny', 'Professional']
...
export default function Repurpose({ title }: MainSelectorProps) {
  ...
  useBeforeunload(
    input !== '' || value !== '' ? (event) => event.preventDefault() : undefined
  )
