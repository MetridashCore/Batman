        ...
        <div className="dark:bg-[#232529] bg-[#F2F2F2] w-full md:px-10 px-2 md:pt-24 pt-6 pb-10 mt-20 md:mt-0  items-center  flex flex-col h-full ">
            {response ? (
                <div className="flex flex-row w-full h-10 items-center justify-end mb-2 gap-x-2">
                    ...
                    <Button
                        onClick={async () =>
                            await NewResponse('expand', response)
                        }
                    ...
                    <Button
                        onClick={async () =>
                            await NewResponse('Shorten', response)
                        }
                        className="bg-red-400"
                        sx={{ backgroundColor: '#d0d8f5', color: '#1f388b' }}
                    >
                    ...
                    <Button
                        onClick={async () =>
                            await NewResponse('Exemplify', response)
                        }
                        className="bg-red-400"
                        sx={{ backgroundColor: '#d0d8f5', color: '#1f388b' }}
                    >
                    ...
                    <Button
                        onClick={async () =>
                            await NewResponse('Simplify', response)
                        }
                        className="bg-red-400"
                        sx={{ backgroundColor: '#d0d8f5', color: '#1f388b' }}
                    >
                ...
                <div>
                    {response ? (
                        ...
                        <div className="flex w-full h-full items-center justify-center mt-40">
                            <p className="text-[#D2D2D2]  text-center">
                                {loading ? 'Generating' : 'Response shows here'}
                            </p>
                        </div>
                    )}
                </div>
