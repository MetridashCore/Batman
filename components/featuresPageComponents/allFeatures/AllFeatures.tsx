        ...
        <>
            <div className="flex flex-col items-center py-8">
                <div className="flex flex-col items-center gap-3">
                    <h1 className="text-[2.5rem] font-bold title-style">
                        All our features
                    </h1>
                        ...
                        <div className="grid auto-rows-auto gap-6">
                            <Card
                                ...
                                text={
                                    <>
                                        <span>
                                            Break free from content block with
                                            fresh video
                                        </span>
                                        <br />
                                        <span>
                                            concepts tailored to your audience.
                                        </span>
                                    </>
                                }
                            />
                                ...
                                <div className="grid gap-6">
                                    <Card
                                        ...
                                        text={
                                            <>
                                                <span>
                                                    Elevate your reach with the
                                                </span>
                                                <br />
                                                <span>
                                                    right set of hashtags
                                                </span>
                                                <br />
                                                <span>date</span>
                                            </>
                                ...
                                <div className="grid gap-6">
                                    ...
                                    <Card
                                        ...
                                        text={
                                            <>
                                                <span>
                                                    Whether it's 280 characters
                                                    or less,
                                                </span>
                                                <br />
                                                <span>
                                                    you'll tweet like a pro.
                                                </span>
                                            </>
                                        }
                                    />
                                    <Card
                                        ...
                                        text={
                                            <>
                                                <span>
                                                    Plan, schedule, and conquer
                                                    with
                                                </span>
                                                <br />
                                                <span>
                                                    our powerful scheduler.
                                                </span>
                                            </>
                                        }
                                    />
                        ...
                        <div className="grid grid-cols-2 auto-rows-auto items-start gap-6">
                            ...
                            <div className="grid gap-6">
                                ...
                                <Card
                                    ...
                                    text={
                                        <>
                                            <span>Fine-tune your strategy</span>
                                            <br />
                                            <span>
                                ...
                                <Card
                                    ...
                                    text={
                                        <>
                                            <span>Expand your reach with</span>
                                            <br />
                                            <span>
                            ...
                            <div className="grid col-span-2">
                                <Card
                                    icon={
                                        <Image src={CSE} alt="Instagram Logo" />
                                    }
