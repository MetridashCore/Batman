    ...
    <div className="pb-10 bg-white">
      <div className="bg-white md:h-[500px] flex md:pl-[7%] md:mr-[3%] md:flex-row flex-col">
        ...
        >
          ...
          <p className="font-normal text-[16px] leading-[18.75px] text-justify text-[#494949] align-center my-8 md:my-0">
            Our cutting-edge AI eliminates the guesswork. We craft the perfect
            prompts so you can focus on bringing your vision to life.
          </p>
        </motion.div>
      </div>
      <div className="bg-white h-[500px] flex  md:px-16 md:mr-[3%]">
        ...
        >
          ...
          <p className="font-normal text-[16px] leading-[18.75px] text-justify text-[#494949] md:w-[387px]">
            Reach your audience wherever they are. From YouTube to Instagram,
            Metridash simplifies content creation across platforms.
          </p>
        </motion.div>
        <motion.div
          ref={ref}
      ...
      <div className="bg-white md:h-[500px] h-[600px] flex pl-[7%] mr-[3%] md:flex-row flex-col">
        ...
        >
          ...
          <p className="font-normal text-[16px] leading-[18.75px] text-justify text-[#494949] align-center my-8 md:my-0">
            Plan, schedule, and optimize your content strategy with ease. Our
            real-time analytics dashboard offers actionable insights for growth.
          </p>
        </motion.div>
      </div>
    </div>
