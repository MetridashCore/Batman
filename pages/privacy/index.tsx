...
const Privacy = () => {
    return (
        <>
            <Head>
                <title>Metridash - Privacy Policy</title>
            </Head>
            <div className="px-[7%] py-[7%] bg-black">
                <div>
                    ...
                    <p className="py-5 leading-6 text-white text-para">
                        ...
                        ElsaRaelyn Pvt Ltd. d/b/a Metridash (“Metridash”)
                        collects, uses, maintains and discloses information
                        collected from users (each, a “User”) of the
                        https://metridash.com website (“Site”), and individuals
                        who are third-party content authors of social media
                        content (“Social Media Authors”). This privacy policy
                        applies to the Site and all products and services
                        offered by Metridash Pvt Ltd.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <h3 className="title-third  leading-[92%] py-3 font-semibold text-white ">
                        Users
                    </h3>
                    <ul className="list-disc text-white text-para">
                        <li className="py-1 leading-6">
                            ...
                            limited to, when Users visit our site, register on
                            the site, place an order, subscribe to the
                            newsletter, and in connection with other activities,
                            services, features or resources we make available on
                            our Site.
                        </li>
                        <li className="py-1 leading-6 ">
                        ...
                        <li className="py-1 leading-6">
                            Users may, however, visit our Site anonymously. We
                            will collect personal identification information
                ...
                <div>
                    ...
                    <p className="py-2 text-white text-para">
                        Metridash receives personal data from third parties such
                        as Facebook, Twitter(X), Instagram, and YouTube for our
                        legitimate interests of serving our customers. We are
                        fully compliant with their public terms and conditions
                        and trust them to protect Social Media Authors through
                        their robust privacy policies.
                    </p>
                    <ul className="list-disc text-white text-para">
                        <li>
                            Metridash collects, uses, processes and stores
                            information that has been made publicly available on
                            the Social Media platforms listed above such as:
                            <br /> 1. names, usernames, handles, or other
                            identifiers; <br />
                            2. the content of the information published via that
                            name, username, handle, or other identifier,
                            including comments, expressions, opinions, posts,
                            etc.; <br />
                            3. profile pictures or other images or videos posted
                            or interacted with; <br />
                            4. publicly disclosed location; <br />
                            5. gender;
                            <br />
                            6. We may also use this information to infer other
                            data, such as the sentiment of the post.
                        </li>
                        <li>
                            To collect & provide customers with data about their
                            YouTube channels, Metridash uses{' '}
                            ...
                            1. In addition to our normal procedure for deleting
                            stored data, you can revoke Metridash's access to
                            your YouTube data via the{' '}
                ...
                <div>
                    ...
                    <p className="text-white text-para ">
                        At any time, you may contact info@metridash.com and
                        request that we:
                    </p>
                    <ul className="list-disc text-white text-para">
                        ...
                        <li>
                            Permanently delete any personal or non-personal data
                            (such as cookies) that we have collected and shared
                        </li>
                ...
                <div>
                    ...
                    <p className="text-white text-para">
                        ...
                        information about them. The User may choose to set their
                        web browser to refuse cookies, or to alert you when
                        cookies are being sent. If they do so, note that some
                        parts of the Site may not function properly. As you
                        browse Metridash, advertising cookies will be placed on
                        your computer so that we can understand what you are
                        interested in. Our advertising partner then enables us
                        to present you with retargeting advertising on other
                        sites based on your previous interaction with Metridash.
                        The techniques our partners employ do not collect
                        personal information such as your name, email address,
                        postal address or telephone number. You can visit
                        networkadvertising.org/choices to opt out of our
                        partners' targeted advertising. It is your right to
                        contact info@metridash.com and request that we delete
                        any cookies that link back to you and your online
                        activity.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <h2 className="title-third  leading-[92%] py-3 font-semibold text-white ">
                        Users
                    </h2>
                    <p className="text-white text-para">
                        Metridash may collect and use Users personal information
                    ...
                    <ul className="list-disc text-white text-para">
                        ...
                        <li>
                            To process payments. We may use the information
                            Users provide about themselves when placing an order
                            only to provide service to that order. We do not
                            share this information with outside parties except
                        ...
                        <li>
                            ...
                            information and updates pertaining to their order.
                        </li>
                        <li>
                        ...
                        <li>
                            If User decides to opt-in to our mailing list, they
                            will receive emails that may include company news,
                ...
                <div>
                    ...
                    <p className="text-white text-para">
                        The legal basis for the data that we collect and process
                        is pursuant to our legitimate interests in providing our
                        Services to our customers.
                    </p>
                </div>

                <div>
                    <p className="title-third  leading-[92%] py-3 font-semibold text-white ">
                        Your information is also used in the following ways:
                    </p>
                    <ul className="text-white text-para">
                        <li>
                            To allow our customers to learn more about their
                            brand, customers, and competitors;
                        </li>
                ...
                <div>
                    ...
                    <p className="text-white text-para">
                        In compliance with our company’s values and GDPR laws,
                        you will always be immediately notified in the unlikely
                ...
                <div>
                    ...
                    <p className="text-white text-para">
                        We share your data with our Customers in the ways
                        outlined in Personal identification information.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p className="text-white text-para">
                        ...
                        that appear on these sites and are not responsible for
                        the practices employed by websites linked to or from our
                        Site. In addition, these sites or services, including
                        their content and links, may be constantly changing.
                        These sites and services may have their own privacy
                        policies and customer service policies. Browsing and
                        interaction on any other website, including websites
                        which have a link to our Site, is subject to that
                ...
                <div>
                    ...
                    <p className="text-white text-para">
                        Metridash has the discretion to update this privacy
                        policy at any time. When we do, we will revise the
                        updated date at the bottom of this page. We encourage
                        Users to frequently check this page for any changes to
                        stay informed about how we are helping to protect the
                ...
                <div>
                    ...
                    <p className="text-white text-para">
                        ...
                        not use our Site. Your continued use of the Site
                ...
                <div>
                    ...
                    <p className="text-white text-para">
                        ...
                        please contact us at: Metridash Pvt Ltd. <br />{' '}
                        https://metridash.com/ <br /> 181 Nethaji Road,
                        Kokkirakulam <br /> Tirunelveli, Tamil Nadu <br /> India{' '}
                        <br /> +91 9994412727 <br /> info@metridash.com <br />
