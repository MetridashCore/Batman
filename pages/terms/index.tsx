  ...
  return (
    <div className="px-[7%] py-[7%] bg-black">
      ...
      <p className="py-1 leading-6 text-white ">
        ...
        this website. This website uses cookies. By using this website and
        agreeing to these terms and conditions, you consent to our Metridash's
      ...
      <p className="py-1 leading-6 text-white ">
        ...
        reserved. Metridash hereby grants you a non-exclusive, non-transferable
        subscription to use the Service during the Term, solely for your
        internal use in accordance with the use parameters described in the
        order form utilized to order such subscription and subject to these
        Terms of Service. By using Metridash to collect data from and optimize
        your social media channels, you're also agreeing to be bound by their
      ...
      <ul className="list-disc text-white">
        <li>
          ...
          requested during the account signup process to obtain an account and
          use the Service, and update this information if it changes.
        </li>
        <li>
          You must be a human being to set up an account and use the Service.
          Accounts may not be created by “bots” or other automated methods.
        </li>
        <li>
          You are responsible for keeping your account and password secure, and
          are also responsible for all activities using your account or
          password. Metridash is not liable for any loss or damage that results
          from your failure to comply with this obligation or unauthorized use
          of your account.
        </li>
        <li>You may never use another’s account without permission.</li>
        <li>
          You must notify Metridash immediately of any breach of security or
      ...
      <p className="py-1 leading-6 text-white ">
        ...
        fees indicated for that service. Payments will be charged on the day you
        sign up for a premium service and will cover the use of that service for
        a monthly or annual period as indicated. Premium service fees are not
        refundable. Metridash offers monthly and annual subscriptions that renew
        until they are canceled by the user. Your subscription will
        automatically renew for another period unless notice of non-renewal is
        provided. Your notice of non-renewal must be received before the renewal
        period begins. You will be billed for the Service until you properly
        cancel your account or Metridash terminates your account. Your
        cancellation may not take effect until completion of the current billing
        cycle. Prices for the Service are subject to change upon 30 days notice
        from Metridash. This notice may be posted on the Metridash website or
        may appear with the Service itself. If you do not agree to the price
        change(s), you may cancel your account during this 30-day period. By
        continuing to use the Service after the effective date of a pricing
        change, you thereby agree to such pricing change. Metridash shall not be
      ...
      <p className="py-1 leading-6 text-white ">
        ...
        Payments are made for the upcoming billing cycle. Metridash does not
      ...
      <p className="py-1 leading-6 text-white ">
        ...
        harmful purpose or activity. You must not use this website to copy,
      ...
      <p className="py-1 leading-6 text-white ">
        ...
        provides you with a user ID and password to enable you to access
        restricted areas of this website or other content or services, you must
        ensure that the user ID and password are kept confidential. Metridash
      ...
      <ul className="list-disc text-white">
        ...
        <li>
          matter which it would be illegal or unlawful for Metridash to exclude
      ...
      <p className="py-1 leading-6 text-white ">
        ...
        against Metridash's officers or employees in respect of any losses you
        suffer in connection with the website. You agree that the limitations of
      ...
      <p className="py-1 leading-6 text-white ">
        ...
        Metridash to a third party in settlement of a claim or dispute on the
        advice of Metridash's legal advisers) incurred or suffered by Metridash
