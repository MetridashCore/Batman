...
import { SignUpValues } from "./type/authValues";
    ...
    return (
        <div className='h-screen bg-black' >
            <div className="flex-1 flex flex-col justify-start items-center py-40 sm:py-20 px-8 sm:px-10 md:px-12 lg:flex-none lg:px-20 xl:px-14">
                ...
                >
                    {({ isSubmitting }) => (
                        <Form className="md:w-3/12 w-full w-100">
                            <div>
                            ...
                            <div className="flex justify-center my-5">
                                <button type="button" className="w-60 text-black bg-white focus:ring-4 focus:outline-none font-medium rounded-full text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 mr-2 mb-2 cursor-pointer"
